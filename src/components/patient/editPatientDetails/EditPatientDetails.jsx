...
const EditPatientDetails = () => {
    ...
    const getUserData = async (e) => {
        try {
            ...
            const details = await axios.get(`https://doctor-project-backend-r5in.onrender.com/getuserdetails`, {
                headers: {
                    'Authorization': `${token}`
                }
            });
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const token = localStorage.getItem('authToken');
            const response = await axios.patch(`https://doctor-project-backend-r5in.onrender.com/updateuserdetails`, profileData, {
                headers: {
                    'Authorization': `${token}`
                }
            });
    ...
    return (
        <div className='editpatientdetails'>
            <div className='editpatientimage'><img className='editpatientprofileimage' src={`https://doctor-project-backend-r5in.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
