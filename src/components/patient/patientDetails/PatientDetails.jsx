...
const PatientDetails = () => {
    ...
    const getUserData = async (e) => {
        try {
            ...
            const details = await axios.get(`https://doctor-project-backend-r5in.onrender.com/getuserdetails`, { headers: { 'Authorization': `${token}` } });
    ...
    return (
        <div className='patientdetails'>
            <div className='patientimage'><img className='patientprofileimage' src={`https://doctor-project-backend-r5in.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
