...
const AdminDetails = () => {
    ...
    return (
        <div className='admindetails'>
            <div className='adminimage'><img className='adminprofileimage' src={`https://doctor-project-backend-r5in.onrender.com/` + adminDetails.profile_image} alt='admin'></img></div>
