...
const EditAdminDetails = () => {
    ...
    return (
        <div className='editadmindetails'>
            <div className='editadminimage'><img className='editadminprofileimage' src={`https://doctor-project-backend-r5in.onrender.com/` + adminDetails.profile_image} alt='admin'></img></div>
