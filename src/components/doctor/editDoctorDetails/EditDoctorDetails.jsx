...
const EditDoctorDetails = () => {
    ...
    return (
        <div className='editdoctordetails'>
            <div className='editdoctorimage'><img className='editdoctorprofileimage' src={`https://doctor-project-backend-r5in.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
