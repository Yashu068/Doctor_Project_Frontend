...
const DoctorDetails = () => {
    ...
    return (
        <div className='doctordetails'>
            <div className='doctorimage'><img className='doctorprofileimage' src={`https://doctor-project-backend-r5in.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
