...
const PrescriptionManager = () => {
  ...
  const submitPrescriptions = async () => {
    ...
    try {
      await axios.post("https://doctor-project-backend-r5in.onrender.com/addDetailsToPatient", { bookingId:id, prescription:prescriptions }, { headers: { 'Authorization': `${token}` } });
